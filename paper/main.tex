...
three correctness-cliff walls (fault-injection rates). We measure all six in
the uncompressed, no-hand-off configuration (the workspace ships a
summarization switch and a capability-routing switch; both disabled to
surface the walls). Single runs, one OpenAI-compatible model (glm-5.1),
